...
X1. Users should be able to create a new blogger
 	- Bloggers should have unique names and ages above 0, and their bio should be over 30 characters long.
X2. Users should be able to see the profile page of a blogger. On this page, a user should see:
...
Post:
X1. Users should be able to create and edit a post
